...
func main() {
	...
	imageSaver := g.GetNodeById(2)

	pathProp := imageLoader.GetPropertyWithName("path")
	pathProp.SetValue("/Users/wadahana/Desktop/sis/target.jpg")

	outPathProp := imageSaver.GetPropertyWithName("path")
	outPathProp.SetValue("/Users/wadahana/Desktop/sis/output.mp4")

	qpProp := imageSaver.GetPropertyWithName("quality")
	qpProp.SetValue(85)
